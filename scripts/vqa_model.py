...
def build_vqa_model(image_input_shape, vocab_size, question_max_len, num_classes):
    ...
    image_dense = Dense(32, activation='relu', kernel_regularizer=l2(0.01))(image_input)
    ...
    question_embedding = Embedding(input_dim=vocab_size, output_dim=32)(question_input)
    question_lstm = LSTM(32, kernel_regularizer=l2(0.01))(question_embedding)
    question_lstm = BatchNormalization()(question_lstm)
    ...
    combined_dense = Dense(32, activation='relu', kernel_regularizer=l2(0.01))(combined)
